...
//
//https://github.com/SFML/SFML/wiki/Source%3A-Simple-File-Logger-%28by-mateandmetal%29
...
namespace ige {
    ...
    public:
        ...
        explicit FileLogger (const char *engine_version, const char *fname = "ige_log.txt") :   numWarnings (0U), numErrors (0U)
        {
